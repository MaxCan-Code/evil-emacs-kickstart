...
#+begin_src emacs-lisp
  (use-package emacs :ensure nil
    ...
    :custom-face (default ((nil :height 120)))
    :init
    ...
    (setopt use-short-answers t
            ...
            ;; initial-buffer-choice 'project-find-file
            initial-buffer-choice 'server-start
...
#+begin_src emacs-lisp
  ...
  (use-package dyalog-mode :vc (:rev :newest) :mode ("\\.apl.\\'" "\\.dyalog\\'")
...
#+begin_src emacs-lisp
  (use-package evil :vc (:rev :newest)
    :bind (:map evil-insert-state-map
                ...
                ("x" . evil-avy-goto-word-0)
                ("X" . avy-goto-char-0-apl)
                :map evil-normal-state-map
                ("S" . avy-goto-char-0-apl)
